    ...
    <>
      ...
      <div className="flex md:hidden justify-between items-center px-4 py-1 border-b-2 border-b-primary">
        ...
        <div className="flex h-16 space-x-5">
          {isMobileMenuOpen ? <div className="hidden tranzition-all"><ThemeToggler /></div> : <div className="flex items-center"><ThemeToggler /></div>}
      ...
      <div
        className={`fixed top-0 left-0 w-full h-full bg-inherit z-50 transform transition-transform duration-700 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
